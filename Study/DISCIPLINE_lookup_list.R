DISCIPLINES <- list(
  "Psychology" = c(
    ...
    # Personality, social, individual differences
    ...
    # Clinical, abnormal, psychiatry-adjacent
    ...
    "psycextra dataset",
    "psyctests dataset",
    "los angeles, ca: western psychological corporation",
    # Health psychology
    "health psychology",
    ...
    # Aesthetics, music, religion (psychology of)
    ...
    # Sport psych (psych focus)
    "psychology of sport and exercise",
    "journal of sport and exercise psychology",
    "journal of motor learning and development",
    # Misc
    "human-animal interaction bulletin",
    "professional and practice-based learning,human fallibility"
),
  ...
  "Management, Marketing & Organizational Behavior" = c(
  ...
  "Public Administration & Policy" = c(
  ...
  "Linguistics & Language Sciences" = c(
    "language",
    "linguistics",
    ...
    "studies in bilingualism,second language acquisition in a study abroad context",
  ...
  "Computer Science & HCI" = c(
    ...
    "proceedings of the fourth international workshop on computing education research",
    ...
    "lecture notes in business information processing,agile processes in software engineering and extreme programming",
    "gesellschaft für informatik e.v.",
    "international journal of social robotics",
    "generative adversarial networks for image-to-image translation"
  )
)
saveRDS(DISCIPLINES, file = "disciplines.rds")
